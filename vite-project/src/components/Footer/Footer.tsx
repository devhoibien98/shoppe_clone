      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="lg:col-span-1">
            <div>@ 2026 Shoppe. Tất cả các quyền được bảo lưu</div>
          </div>
          <div className="lg:col-span-2">
            <div>
              Quốc gia & Khu vực: Argentina Singapore Indonesia Thái Lan Malaysia Việt Nam
              Philippines Brazil México Đài Loan
            </div>
          </div>
        </div>
